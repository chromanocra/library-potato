...
// ─────────────────────────────────────────────────────────────────────────────
// LOAD RESERVASI — GET /api/reservasi
// ─────────────────────────────────────────────────────────────────────────────
async function loadReservasi() {
    ...
    tbody.innerHTML = `
        <tr><td colspan="9" class="text-center py-4" style="color:#6b7280;">
            <i class="fas fa-spinner fa-spin me-2"></i> Memuat data reservasi...
        </td></tr>`;
    ...
    try {
        ...
        console.error("loadReservasi fetch error:", err);
        tbody.innerHTML = `
            <tr><td colspan="9" class="text-center py-5">
...
// ─────────────────────────────────────────────────────────────────────────────
// APPROVE — PUT /api/reservasi/{id}/approve
// ─────────────────────────────────────────────────────────────────────────────
async function approveItem(pinjamID) {
    ...
    try {
        const res = await fetch(`${API_URL}/reservasi/${pinjamID}/approve`, {
            method: "PUT",
...
async function rejectItem(pinjamID) {
    ...
    try {
        const res = await fetch(`${API_URL}/reservasi/${pinjamID}/reject`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
        });
        const result = await res.json();
